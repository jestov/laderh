...
const BrandStripTitle = () => {
  return (
    <section className='w-full flex flex-col gap-3 py-12 text-center items-center'>
      <div className='flex flex-col gap-4 md:gap-0 md:flex-row items-center px-[15px] xl:px-0'>
        <Image src="/img/heart_draw.svg" width={70} height={70} className='-mr-2 z-0 relative w-[60px] md:w-[90px]' alt="" />
