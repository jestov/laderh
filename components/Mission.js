...
const Mission = () => {
  ...
  return (
    <section className='w-full flex-col justify-center bg-purpledark relative'>
      <Image src="/img/shines.svg" width={100} height={100} className='absolute right-10 md:right-14 bottom-[350px] md:bottom-[220px] animate-pulse'/>
      <div className='w-full flex justify-end'>
        <div className='max-w-8xl flex flex-col md:flex-row md:gap-12 w-full'>
          <div className='flex flex-col gap-8 md:gap-10 lg:gap-12 justify-center items-start text-white p-[45px] 2xl:pl-[120px]'>
            ...
            <h5>
              ...
              <span className='flex gap-3 text-sm'>
                Fundadora de <Link href="https://wehubble.com"> <Image src="/img/hubble_logo.svg" width="200" height="200" className='h-[25px] w-auto object-contain cursor-pointer' /></Link>
              </span>
            </h5>
          ...
          <Image src="/img/dora_mision.jpg" width={1200} height={1200} className='h-full w-full object-cover mix-blend-screen' />
        </div>
      </div>
        ...
        <div className='max-w-8xl flex flex-col md:flex-row justify-between items-center w-full px-[30px] md:px-[45px] 2xl:px-[120px] text-white gap-10'>
          <div className='text-base font-medium tracking-wide'>
            <p className='gap-2 items-center inline'>
              En <Link href="https://wehubble.com"> <Image src="/img/hubble-horizontal.svg" width="200" height="200" className='h-[11px] w-auto object-contain cursor-pointer inline mx-1.5 -mt-1.1' /></Link> transformamos retos de capital humano en soluciones reales.
            </p>
