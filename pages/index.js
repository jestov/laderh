  ...
  return (
    <Layout backgroundColor="bg-pink">
      ...
      />
        ...
        <Image src="/img/dora-hero.png" width={2100} height={200} alt="Dora Valdez" className='relative z-index-2 md:h-[70vh] xl:h-[90vh] xl:-mr-[80px] 2xl:-mr-0 2xl:h-[93vh] object-contain'/>
