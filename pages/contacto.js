...
export default function Index({ globalData }) {
  ...
  return (
    <Layout backgroundColor="bg-purpledark">
      ...
      />
      <main className="flex flex-col gap-8 lg:gap-16 pt-28 lg:pt-48 max-w-7xl mx-auto items-start px-[20px] z-1 relative w-full">
        <div className='w-full'>
          <div className='flex flex-col md:flex-row gap-4 items-center justify-center z-2'>
            ...
            <div className='flex'>
              ...
              <Image className='-ml-6.5 -mb-4.5' src="/img/contact.svg" width={40} height={40} alt="" />
            </div>
          </div>  
        </div>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-14 lg:py-8 px-[30px] lg:px-[60px]'>
